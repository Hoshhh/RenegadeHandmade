...
const SingleProductPage = (props: ProductProps) => {
  ...
  return (
    <Stack direction="row" justifyContent="center" sx={{ marginLeft: "5%", marginRight: "5%", marginTop: "0px" }}>
        <Box flex={5} bgcolor="#F1EFF1" padding={2} sx={{ display: { xs: "none", sm: "none", md: "flex"}, minHeight: "90vh", flexDirection: "column", justifyContent:"center", alignItems: "center" }}>
            <img src={image} alt="" style={{ maxWidth: "75%",  maxHeight: "500px", marginBottom: "5%", marginTop: "5%", marginLeft: "auto", marginRight: "auto" }}/>
        ...
        <Box flex={5} bgcolor="#F1EFF1" padding={2} sx={{ display: "flex", minHeight: "90vh", flexDirection: "column", justifyContent:"center" }}>
